"""remove not use field writing session

Revision ID: 79b0d600f4b4
Revises: e14d4d43a04f
Create Date: 2025-10-21 22:01:11.220006
...
revision: str = '79b0d600f4b4'
down_revision: Union[str, Sequence[str], None] = 'e14d4d43a04f'
...
def upgrade() -> None:
    ...
    op.drop_column('writing_sessions', 'session_data')
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('writing_sessions', sa.Column('session_data', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
